...
class NP3566CDApi:
    ...
    def get_data99(
        ...
        valley_from: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Format - ####.###.")] = None,
        valley_to: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Format - ####.###.")] = None,
        ...
        :param valley_from: Format - ####.###.
        :type valley_from: float
        :param valley_to: Format - ####.###.
        :type valley_to: float
        ...
        _param = self._get_data99_serialize(
    ...
    @validate_call
    def get_data99_without_preload_content(
        self,
        ocp_apim_subscription_key: Annotated[StrictStr, Field(description="The subscription key assigned to your ERCOT Public API account.")],
        delivery_date_from: Annotated[Optional[StrictStr], Field(description="Format - yyyy-MM-dd.")] = None,
        delivery_date_to: Annotated[Optional[StrictStr], Field(description="Format - yyyy-MM-dd.")] = None,
    ...
    def _get_data99_serialize(
        ...
        if valley_from is not None:
            
            _query_params.append(('valleyFrom', valley_from))
            
        if valley_to is not None:
            
            _query_params.append(('valleyTo', valley_to))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/np3-566-cd/lf_by_model_study_area',
