...
class NP6346CDApi:
    ...
    def get_data5(
        ...
        houston_from: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Format - ####.###.")] = None,
        houston_to: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Format - ####.###.")] = None,
        ...
        :type west_to: float
        :param houston_from: Format - ####.###.
        :type houston_from: float
        :param houston_to: Format - ####.###.
        :type houston_to: float
        ...
        _param = self._get_data5_serialize(
    ...
    @validate_call
    def get_data5_without_preload_content(
        self,
        ocp_apim_subscription_key: Annotated[StrictStr, Field(description="The subscription key assigned to your ERCOT Public API account.")],
        operating_day_from: Annotated[Optional[StrictStr], Field(description="Format - yyyy-MM-dd.")] = None,
        operating_day_to: Annotated[Optional[StrictStr], Field(description="Format - yyyy-MM-dd.")] = None,
    ...
    def _get_data5_serialize(
        ...
        if houston_from is not None:
            
            _query_params.append(('houstonFrom', houston_from))
            
        if houston_to is not None:
            
            _query_params.append(('houstonTo', houston_to))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/np6-346-cd/act_sys_load_by_fzn',
