...
class NP4188CDApi:
    ...
    def get_data29(
        ...
        ancillary_type: Annotated[Optional[StrictStr], Field(description="Format - abc123.")] = None,
        mcpc_from: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Format - ####.###.")] = None,
        mcpcto: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Format - ####.###.")] = None,
        ...
        :param ancillary_type: Format - abc123.
        :type ancillary_type: str
        :param mcpc_from: Format - ####.###.
        :type mcpc_from: float
        :param mcpcto: Format - ####.###.
        :type mcpcto: float
        ...
        _param = self._get_data29_serialize(
    ...
    @validate_call
    def get_data29_without_preload_content(
        self,
        ocp_apim_subscription_key: Annotated[StrictStr, Field(description="The subscription key assigned to your ERCOT Public API account.")],
        delivery_date_from: Annotated[Optional[StrictStr], Field(description="Format - yyyy-MM-dd.")] = None,
        delivery_date_to: Annotated[Optional[StrictStr], Field(description="Format - yyyy-MM-dd.")] = None,
    ...
    def _get_data29_serialize(
        ...
        if ancillary_type is not None:
            
            _query_params.append(('ancillaryType', ancillary_type))
            
        if mcpc_from is not None:
            
            _query_params.append(('MCPCFrom', mcpc_from))
            
        if mcpcto is not None:
            
            _query_params.append(('MCPCTo', mcpcto))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/np4-188-cd/dam_clear_price_for_cap',
