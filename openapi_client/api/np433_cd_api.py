...
class NP433CDApi:
    ...
    def get_data17(
        ...
        quantity_from: Annotated[Optional[StrictInt], Field(description="Format - ###.")] = None,
        quantity_to: Annotated[Optional[StrictInt], Field(description="Format - ###.")] = None,
        ...
        :param quantity_from: Format - ###.
        :type quantity_from: int
        :param quantity_to: Format - ###.
        :type quantity_to: int
        ...
        _param = self._get_data17_serialize(
    ...
    @validate_call
    def get_data17_without_preload_content(
        self,
        ocp_apim_subscription_key: Annotated[StrictStr, Field(description="The subscription key assigned to your ERCOT Public API account.")],
        delivery_date_from: Annotated[Optional[StrictStr], Field(description="Format - yyyy-MM-dd.")] = None,
        delivery_date_to: Annotated[Optional[StrictStr], Field(description="Format - yyyy-MM-dd.")] = None,
    ...
    def _get_data17_serialize(
        ...
        if quantity_from is not None:
            ...
            _query_params.append(('quantityFrom', quantity_from))
            
        if quantity_to is not None:
            
            _query_params.append(('quantityTo', quantity_to))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/np4-33-cd/dam_as_plan',
