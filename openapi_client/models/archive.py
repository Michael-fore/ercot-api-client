...
class Archive(BaseModel):
    ...
    """ # noqa: E501
    doc_id: Optional[StrictInt] = Field(default=None, alias="docId")
    friendly_name: Optional[StrictStr] = Field(default=None, alias="friendlyName")
    post_datetime: Optional[datetime] = Field(default=None, alias="postDatetime")
    links: Optional[List[Link]] = None
    __properties: ClassVar[List[str]] = ["docId", "friendlyName", "postDatetime", "links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "postDatetime": obj.get("postDatetime"),
