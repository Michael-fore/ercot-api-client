...
class ReportMetadata(BaseModel):
    ...
    report_display_name: Optional[StrictStr] = Field(default=None, alias="reportDisplayName")
    report_id: Optional[StrictStr] = Field(default=None, alias="reportId")
    report_emil: Optional[StrictStr] = Field(default=None, alias="reportEMIL")
    download_limit: Optional[StrictInt] = Field(default=None, alias="downloadLimit")
    default_filter: Optional[StrictStr] = Field(default=None, alias="defaultFilter")
    __properties: ClassVar[List[str]] = ["reportName", "reportDisplayName", "reportId", "reportEMIL", "downloadLimit", "defaultFilter"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reportDisplayName": obj.get("reportDisplayName"),
            "reportId": obj.get("reportId"),
            "reportEMIL": obj.get("reportEMIL"),
            "downloadLimit": obj.get("downloadLimit"),
            "defaultFilter": obj.get("defaultFilter")
        })
        return _obj
